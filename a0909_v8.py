...
if args.results_dir == '':
    args.results_dir = './new_caches_v8'\
    +'/T'+str(args.loss_t) + '_L'+str(args.loss_l)+'_shuffle-temp'+str(args.shuffle_temp) \
    +'/bt'+str(args.batch_size) \
    +'/cache-' + datetime.now().strftime("%Y-%m-%d-%H-%M-%S-moco") 
