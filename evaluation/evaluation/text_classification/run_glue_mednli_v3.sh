...
--master_port 29502 \
  ...
  --save_total_limit 1 \
  --fp16 \
  --output_dir ./results/shuffled_model/${MODEL_NAME}/${TASK_NAME}/${NOTICE}/ \
  --tokenizer_name microsoft/BiomedVLP-CXR-BERT-specialized \
  --model_revision v1.1 \
  --trust_remote_code \
  --resume /jet/home/lisun/work/xinliu/hi-ml/hi-ml-multimodal/src/new_caches_v3/cache-2023-09-30-07-09-48-moco/model_last.pth \
