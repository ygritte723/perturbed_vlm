...
from utils_wo import CheXpertDataSet, ExpandChannels, ContrastiveModel
...
ac_fn = 'output/wopretrain/bt64/old_test_accuracies.txt'
# # Set up logging
...
def run():
  ...
  #  test_header = [
   ...
   # for i in test_header:
	 #   print(i+': ')
	#    a = len([i for i in datasetTest if i[1][c]==1])
	 #   c = c + 1
	 #   print(a)
	#print(': ', datasetTest[:][1]))
