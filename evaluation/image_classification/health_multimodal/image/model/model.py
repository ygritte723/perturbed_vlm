...
class ImageModel(BaseImageModel):
    ...
    def __init__(
        ...
        self.classifier = (
            self.create_downstream_classifier()
            if downstream_classifier_kwargs
            else None
        )
    ...
    def create_downstream_classifier(self, **kwargs: Any) -> MultiTaskModel:
        ...
        downstream_classifier_kwargs = (
            kwargs if kwargs else self.downstream_classifier_kwargs
        )
    ...
    def get_patchwise_projected_embeddings(
        ...
        assert (
            not self.training
        ), "This function is only implemented for evaluation mode"
