...
from utils import TextShuffler, pre_caption, ContrastiveModel
...
test_loader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=2, pin_memory=False, collate_fn=collate_fn)

device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')
model = ContrastiveModel()
checkpoint = torch.load('/jet/home/lisun/work/xinliu/hi-ml/hi-ml-multimodal/src/caches/cache-2023-09-21-20-27-34-moco/model_last.pth', map_location=device)
