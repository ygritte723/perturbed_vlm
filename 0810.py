...
#!tar -xvzf /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/dataset/images
#!tar -xvzf /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/NLMCXR_png.tgz
#!unzip /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/dataset/archive.zip
#!mv /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/*.png /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/images
#!mv /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/*.csv /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/dataset
#!mv /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/images /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/dataset
#!mv /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/reports /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/dataset
#!ls /content/drive/MyDrive/hi-ml/hi-ml-multimodal/src/images/images_normalized | wc -l
...
# Commented out IPython magic to ensure Python compatibility.
# %cd /content/drive/MyDrive/hi-ml/hi-ml-multimodal
#!make env
# Commented out IPython magic to ensure Python compatibility.
#!pip install timm
...
# Commented out IPython magic to ensure Python compatibility.
#!cd /ocean/projects/asc170022p/lisun/xinliu/hi-ml/hi-ml-multimodal/src
# %ls
...
class ContrastiveModel(nn.Module):
    ...
    def contrastive_loss(self, input_ids, attention_mask, image_input):
        ...
        q = nn.functional.normalize(image_encoding, dim=1)  # already normalized
        k = nn.functional.normalize(text_encoding, dim=1)  # already normalized
        # compute logits
